class ForecastMeteoDto {
  ...
  ForecastMeteoDto.fromJson(dynamic json) {
...
class Hourly {
  ...
  Hourly.fromJson(dynamic json) {
    ...
    relativehumidity2m = json['relativehumidity_2m'] != null ? json['relativehumidity_2m'].cast<num>() : [];
    windspeed10m = json['windspeed_10m'] != null ? json['windspeed_10m'].cast<num>() : [];
